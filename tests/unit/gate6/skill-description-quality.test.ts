...
import { SkillDescriptionQualityValidator } from "../../../src/gates/gate6-skills/validators/skill-description-quality.js";
...
describe("SkillDescriptionQualityValidator", () => {
  const validator = new SkillDescriptionQualityValidator();

  it("passes for good description starting with action verb", async () => {
